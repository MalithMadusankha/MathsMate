...
const GAME_CARDS: GameCardConfig[] = [
  {
    ...
    emoji: "🔢",
    title: "Counting",
    description: "Count objects & numbers",
    accentColor: "#6C3DD3",
    difficulty: "Easy",
    stars: 3,
  },
  ...
  },
  {
    ...
    emoji: "🎯",
    title: "Drag & Drop",
    description: "Place numbers correctly",
    accentColor: "#8B5CF6",
    difficulty: "Easy",
    stars: 5,
  },
  ...
  },
  {
    ...
    description: "Math through adventures",
    accentColor: "#10B981",
    difficulty: "Easy",
    stars: 4,
  },
...
const GameCard = ({ config, colors, onPress }: GameCardProps): JSX.Element => {
  ...
  return (
    <Animated.View
      style={[styles.gameCardWrap, { transform: [{ scale: scaleAnim }] }]}
    >
      <TouchableOpacity
        style={[
          styles.gameCard,
        ...
        <View style={styles.cardFooter}>
          ...
          >
            <Text
              style={[
                styles.diffText,
                { color: DIFFICULTY_COLOR[config.difficulty] },
              ]}
            >
              {config.difficulty}
            </Text>
...
const HomeScreen = (): JSX.Element => {
  ...
  const [dailyChallenge, setDailyChallenge] =
    useState<DailyChallengeResponse | null>(null);
  ...
  const dailyChallengeCard =
    (dailyChallenge &&
      GAME_CARDS.find(
        (gameCard) => gameCard.type === dailyChallenge.gameType,
      )) ??
    DAILY_CHALLENGE;
